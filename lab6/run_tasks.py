from lab6.task1.src.main import task1
from lab6.task2.src.main import task2
from lab6.task5.src.main import task5
from lab6.task6.src.main import task6
from lab6.utils import read_lines
import os
